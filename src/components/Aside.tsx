...
function Aside(props : {
    contentCallback: React.Dispatch<React.SetStateAction<AlbumType[]>>,
    albumButtonTypeCallback: React.Dispatch<React.SetStateAction<albumButtonType>>
}) {
        ...
        <aside className="aside">
            <div className="aside__fixed-block">
                <a href="#" title="Spotibye" className="logo link link_with-icon">
                    <img src={require("../icons/logo.png")} width="25" height="25" alt="Logo"/>
                ...
                <div className="aside-nav">
                    <nav className="aside-nav__top-nav">
                            ...
                            get_new_releases(0, 20).then(
                                (albums) => are_albums_saved(albums.albums.items)
                                    .then((albums_saved) => props.contentCallback(
                                        albums.albums.items.map((album: any, index: any) => Object.assign(album, {saved: albums_saved[index]}))
                                    ))
                                    .then(() => props.albumButtonTypeCallback("Save"))
                            )
                        }}>
                            <img src={require("../icons/home.png")} width="20" height="20" alt="Home"/>
                            <h1 className="aside-nav-link__text">Home</h1>
                        </a>
                        <a href="#" title="Search" className="aside-nav-link link link_with-icon">
                            <img src={require("../icons/search.png")} width="20" height="20" alt="Search"/>
                        ...
                        <a href="#" title="Your Library" className="aside-nav-link link link_with-icon" onClick={(e) => {
                            get_saved_albums(0, 20).then((albums) => props.contentCallback(albums.items.map((val: any) => val.album)))
                                .then(() => props.albumButtonTypeCallback("Remove"))
                        }}>
                            <img src={require("../icons/library.png")} width="20" height="20" alt="Library"/>
                    ...
                    <nav className="aside-nav__bottom-nav">
                        <a href="#" title="Create playlist" className="aside-nav-link link link_with-icon">
                            <img src={require("../icons/create_playlist.png")} width="20" height="20" alt="Create playlist"/>
                        ...
                        <a href="#" title="Liked songs" className="aside-nav-link link link_with-icon">
                            <img src={require("../icons/liked_songs.png")} width="20" height="20" alt="Liked songs"/>
